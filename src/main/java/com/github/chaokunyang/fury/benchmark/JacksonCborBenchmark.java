...
public class JacksonCborBenchmark extends BenchmarkBase {
  private static final ObjectMapper mapper = new CBORMapper(); // create once, reuse
  ...
  public static void main(String[] args) throws IOException {
    if (args.length == 0) {
      String commandLine =
        "com.*JacksonCborBenchmark.* -f 3 -wi 5 -i 5 -t 1 -w 2s -r 2s -rf csv";
